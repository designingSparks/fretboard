'''
Configuration of the custom logger.
Example:
from mylog import *
logger = logging.getLogger('glead.' + __name__) 
...
root_logger = logging.getLogger('glead') #set to '' if you want to display logs of other modules
root_logger.addHandler(console) 
root_logger.setLevel(logging.DEBUG) #Uncomment to enable logging. Default level is WARNING

def get_logger(name):
    return logging.getLogger('glead.' + name)